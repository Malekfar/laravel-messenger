...
class MessengerServiceProvider extends ServiceProvider
{
    ...
    protected function configure()
    {
        $this->mergeConfigFrom(
            base_path('vendor/malekfar/cmgmyr-messenger/config/config.php'),
            'messenger'
        );
    }
    ...
    protected function offerPublishing()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([
                base_path('vendor/malekfar/cmgmyr-messenger/config/config.php') => config_path('messenger.php'),
            ], 'config');

            $this->publishes([
                base_path('vendor/malekfar/cmgmyr-messenger/migrations') => base_path('database/migrations'),
            ], 'migrations');
        }
    }
    ...
    protected function setUserModel()
    {
        ...
        $this->app->make('Cmgmyr\Messenger\Controllers\Messenger');
